export const ALL_TOOLS = [
  ...
  { name: "SIP Calculator", href: "/calculators/sip", desc: "Calculate returns on your Systematic Investment Plan (SIP) mutual funds." },
  { name: "EMI Calculator", href: "/calculators/emi", desc: "Calculate your Equated Monthly Installment (EMI) for home, car, or personal loans." },
  { name: "PPF Calculator", href: "/calculators/ppf", desc: "Calculate maturity value and interest earned on your Public Provident Fund (PPF)." },
